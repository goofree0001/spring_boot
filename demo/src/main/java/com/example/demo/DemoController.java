...
public class DemoController {
	...
	@Validated EditForm editForm, BindingResult bindingResult,
	MainForm mainForm,
//	EditForm editForm,
...
//	Model model
	...
	if (("edit".equals(path) && !("regist".equals(mode))) || "delete".equals(path) || "csv_download".equals(path)) {
